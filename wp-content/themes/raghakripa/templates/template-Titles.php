        ...
        <section class="cmt-row portfolio-style-2-section clearfix">
            <div class="container">
				...
				<?php 					
					...
					<?php
						$loop = new WP_Query( array('post_type' => 'outtitle_type','category_name' => $slug, 'ignore_sticky_posts' => 1, 'paged' => $paged, 'order' => 'ASC', 'posts_per_page' => 12 ) );
                                ...
                                <div class="featured-thumbnail img-fluid">
									...
									<div class="featured-content text-center">
										<div class="featured-title pt-12 pb-15">
											<h5><a href="<?php the_permalink(); ?>" title="<?php echo get_the_title(); ?>"><?php echo get_the_title(); ?></a></h5>
										</div>
									</div>	
